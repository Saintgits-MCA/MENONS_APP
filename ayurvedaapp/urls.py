...
# casehistdit
    ...
    path('dotmatrixview/', views.dotmatrixview, name='dotmatrixview'),
    path('search_medicineapi/', views.search_medicineapi, name='search_medicineapi'),
    path('search_treatmentapi/', views.search_treatmentapi, name='search_treatmentapi'),
    path('api/search-procedures/', views.search_procedures_api, name='search_procedures_api'),


    path('uploadstock/', views.upload_stock, name='upload_stock'),
    path('preview-stock/', views.preview_stock, name='preview_stock'),
    path('save-stock/', views.save_stock, name='save_stock'),
    path('view-saved-stock/', views.view_saved_stock, name='view_saved_stock'),
    path('reset-stock/', views.reset_stock_upload, name='reset_stock'),
    ...
    path('export-stock/', views.export_stock_excel, name='export_stock'),
    ...
    path('staffwise-bill-analysis/', views.staffwise_bill_analysis, name='staffwise_bill_analysis'),
    path('casuality_invoice_detail_staffwise/', views.casuality_invoice_detail_staffwise, name='casuality_invoice_detail_staffwise'),
    path('lab_invoice_detail_staffwise/', views.lab_invoice_detail_staffwise_report, name='lab_invoice_detail_staffwise_report'),
    path('purchase-invoice-detail-staffwise/', views.purchase_invoice_detail_staffwise, name='purchase_invoice_detail_staffwise'),
    path('registration-fee-invoice-list/', views.registration_fee_invoice_list, name='registration_fee_invoice_list'),
    path('complaints-master-list/', views.complaints_master_list, name='complaints_master_list'),
    path('complaints-master-add/', views.complaints_master_add, name='complaints_master_add'),
    path('complaints-master-edit/', views.complaints_master_edit, name='complaints_master_edit'),
    path('search-complaints/', views.search_complaints, name='search_complaints'),  
    path('dotmatrixview/', views.dotmatrixview, name='dotmatrixview'),
    path('dotmatrixprint/', views.dotmatrixprint, name='invdotmatrixprint'),
    path('get-patient-ip-credit-balance/', views.get_patient_ip_credit_balance, name='get_patient_ip_credit_balance'),
    path('save_casehistoryprocedure/', views.save_casehistoryprocedure, name='save_casehistoryprocedure'),
    path('get_procedure_history/', views.get_procedure_history, name='get_procedure_history'),
    path('get-patient-billing-costs/', views.get_patient_billing_costs, name='get_patient_billing_costs'),
    path('get-patient-procedure-details/', views.get_patient_procedure_details, name='get_patient_procedure_details'),
